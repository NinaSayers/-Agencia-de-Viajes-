...
namespace TravelAgency.Infrastructure.Migrations
{
    ...
    [Migration("20240328005804_AgencyOffer")]
    partial class AgencyOffer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelAgency.Domain.Entities.AgencyOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelAgency.Domain.Entities.AgencyOffer", b =>
                {
                    b.HasOne("TravelAgency.Domain.Entities.Agency", null)
                        .WithMany("AgencyOffers")
                        .HasForeignKey("AgencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TravelAgency.Domain.Entities.LodgingOffer", null)
                        .WithMany("AgencyOffers")
